...
@Component({
  selector: 'app-relatorios-atendimento',
  templateUrl: './relatorios-atendimento.component.html',
  styleUrls: ['./relatorios-atendimento.component.css']
})
export class RelatoriosAtendimentoComponent implements OnInit {
