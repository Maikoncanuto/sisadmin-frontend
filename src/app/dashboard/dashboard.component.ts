...
export class DashboardComponent implements OnInit, AfterViewInit {
    ...
    listagemUnidade(): void {
        this._router.navigate(['/unidades/listar-unidade']);
    }

    cadastrarUsuario(): void {
        this._router.navigate(['/usuarios/criar-usuario']);
    }

    listagemUsuario(): void {
    ...
    listagemAtendimento(): void {
        this._router.navigate(['/atendimentos/listar-atendimento']);
    }

    cadastroAtendimento(): void {
        this._router.navigate(['/atendimentos/criar-atendimento']);
    }

    agendarAula(): void {
        this._router.navigate(['/cursos/agendar-aula']);
    }

    relatoriosAtendimento(): void {
        this._router.navigate(['/atendimentos/relatorio-atendimento']);
    }
